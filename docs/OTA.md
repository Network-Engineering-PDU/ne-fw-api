...
Host `metadata.json` and `firmware.bin` in the repository root:
...
Repository: [github.com/Network-Engineering-PDU/firmware-update](https://github.com/Network-Engineering-PDU/firmware-update)
